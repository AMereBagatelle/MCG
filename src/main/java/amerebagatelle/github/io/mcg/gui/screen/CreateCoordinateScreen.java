...
public class CreateCoordinateScreen extends Screen {
    ...
    protected void init() {
        ...
        super.init();
        this.coordinateNameField = new TextFieldWidget(this.textRenderer, 20, 46, 200, 20, new TranslatableText("mcg.write_coordinates_screen.enterName"));
        this.coordinateNameField.setSelected(true);
        this.children.add(coordinateNameField);
        this.coordinateXField = new TextFieldWidget(this.textRenderer, 20, 86, 50, 20, new TranslatableText("mcg.write_coordinates_screen.enterX"));
        this.coordinateXField.setTextPredicate(coordinateFilter);
        this.children.add(coordinateXField);
        this.coordinateYField = new TextFieldWidget(this.textRenderer, 100, 86, 50, 20, new TranslatableText("mcg.write_coordinates_screen.enterY"));
        this.coordinateYField.setTextPredicate(coordinateFilter);
        this.children.add(coordinateYField);
        this.coordinateZField = new TextFieldWidget(this.textRenderer, 180, 86, 50, 20, new TranslatableText("mcg.write_coordinates_screen.enterZ"));
        this.coordinateZField.setTextPredicate(coordinateFilter);
        this.children.add(coordinateZField);
        this.coordinateDetailsField = new TextFieldWidget(this.textRenderer, 20, 126, 300, 20, new TranslatableText("mcg.write_coordinates_screen.enterDetails"));
        this.children.add(coordinateDetailsField);
        this.addButton = this.addButton(new ButtonWidget(20, this.height - 30, 100, 20, new TranslatableText("mcg.write_coordinates_screen.addCoordinate"), ctx -> this.andAndClose()));
        this.addButton(new ButtonWidget(140, this.height - 30, 100, 20, new TranslatableText("mcg.write_coordinates_screen.cancelAdd"), ctx -> this.onClose()));
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float delta) {
        ...
        this.drawStringWithShadow(matrixStack, this.textRenderer, I18n.translate("mcg.write_coordinates_screen.enterName"), coordinateNameField.x, coordinateNameField.y - 15, textColor);
        this.coordinateNameField.render(matrixStack, mouseX, mouseY, delta);
        this.drawStringWithShadow(matrixStack, this.textRenderer, I18n.translate("mcg.write_coordinates_screen.enterX"), coordinateXField.x, coordinateXField.y - 15, textColor);
        this.coordinateXField.render(matrixStack, mouseX, mouseY, delta);
        this.drawStringWithShadow(matrixStack, this.textRenderer, I18n.translate("mcg.write_coordinates_screen.enterY"), coordinateYField.x, coordinateYField.y - 15, textColor);
        this.coordinateYField.render(matrixStack, mouseX, mouseY, delta);
        this.drawStringWithShadow(matrixStack, this.textRenderer, I18n.translate("mcg.write_coordinates_screen.enterZ"), coordinateZField.x, coordinateZField.y - 15, textColor);
        this.coordinateZField.render(matrixStack, mouseX, mouseY, delta);
        this.drawStringWithShadow(matrixStack, this.textRenderer, I18n.translate("mcg.write_coordinates_screen.enterDetails"), coordinateDetailsField.x, coordinateDetailsField.y - 15, textColor);
